...
module Optics
  ...
  variable :refractive_index_of_first_medium,  alias: :mu1, within: REFRACTIVE_INDEX
  variable :refractive_index_of_second_medium, alias: :mu2, within: REFRACTIVE_INDEX
