...
export const BOOK = [
  ...
  },
  {
    ...
    chapters: [
      ...
      { page: "light/into-air.html", files: [] },
      { page: "light/refractive-index.html", files: [] },
      { page: "light/relative-refractive-index.html", files: [ "lib/light/relative_index.rb" ] },
...
const TITLES = {
  ...
  "light/refractive-index.html": "2.8 · Refractive Index",
  "light/relative-refractive-index.html": "2.9 · Relative Refractive Index",
